...
public class CustomerDetailDTO {
    ...
    public String getEngagementLevel() {
        ...
        if (orderCount != null && orderCount > 5) score += 2;
        if (reviewCount != null && reviewCount > 3) score += 1;
        if (wishlistItemCount != null && wishlistItemCount > 5) score += 1;
        if (consultationCount != null && consultationCount > 0) score += 1;
